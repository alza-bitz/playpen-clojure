...
(with-open [in (:body (hc/get "https://archive.org/download/stackexchange/astronomy.stackexchange.com.7z"
            ...
            out (-> "data/stackexchange/raw/astronomy.stackexchange.com.7z"
...
(comment
  (def ^:private reader
    (bom/bom-reader "data/stackexchange/raw/Users.xml")))
...
(with-open [users (bom/bom-reader "data/stackexchange/raw/Users.xml")]
  (->
